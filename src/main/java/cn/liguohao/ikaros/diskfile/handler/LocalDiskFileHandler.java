...
import cn.liguohao.ikaros.service.impl.FileServiceImpl;
...
public class LocalDiskFileHandler extends AbstractDiskFileHandler{
    ...
    @Override
    public Map<String, String> getDefiniteTypeObjectStorageInfoMap() {
        return getObjectStorageInfoMap(DiskFilePlace.LOCAL);
    }

    @Override
    public File definiteObjectStorageFileUpload(Map<String,String> objectStorageInfoMap, byte[] dataBtyes, File dbFile) throws IOException{
        // 构建磁盘路径文件
        ...
        // 其它默认值设置
        dbFile.setPlace(DiskFilePlace.LOCAL.getName());
        // 返回数据库文件对象
        return dbFile;
    }

    @Override
    protected void definiteObjectStorageFileDelete(Map<String,String> objectStorageInfoMap, String relativePath) throws IOException {
        java.io.File destFile = new java.io.File(CUTTENT_USER_DIRECTORY_PATH + relativePath);
