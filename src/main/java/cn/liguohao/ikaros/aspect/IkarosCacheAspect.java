...
public class IkarosCacheAspect {
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Example example = (args[0] instanceof Example)?(Example)args[0]:null;
        // 特定的唯一的缓存键 查询条件类名+执行的方法全路径名+查询参数JSON字符串
        String cacheKey = new StringBuffer()
                .append((example!=null)?example.getProbeType().getName():null)
